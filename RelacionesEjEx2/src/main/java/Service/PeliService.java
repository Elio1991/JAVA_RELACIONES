...
public class PeliService {
    ...
    public List<Pelicula> crearPelicula() {
        ...
        do {
            ...
            System.out.println("Ingrese la duración de la película en minutos (ej: 180)");
            peli.setDuracion(leer.nextDouble());
            System.out.println("Ingrese la edad mínima recomendada de la película");
            peli.setEdadMinima(leer.nextInt());
            System.out.println("Ingrese el director de la película");
            peli.setDirector(leer.next());
            pelis.add(peli);
            System.out.println("Desea seguir agregando películas a la lista (S/N)");
            opc = leer.next();
            
            while (!opc.equalsIgnoreCase("S") && !opc.equalsIgnoreCase("S")) {
