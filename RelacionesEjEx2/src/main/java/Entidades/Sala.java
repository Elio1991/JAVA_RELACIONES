...
public class Sala {
    ...
    public Sala() {
        // Inicializo la matriz en LIBRE
        this.asientos = new EstadoAsiento[8][6];
        this.espectadores = new Espectador[8][6];
        //inicializo la matriz espectadores en null
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 6; j++) {
                asientos[i][j] = EstadoAsiento.LIBRE;
                espectadores[i][j] = null;
            }
        }
    }

    public Sala(Espectador[][] espectadores, EstadoAsiento[][] asientos) {
    ...
    public String toString() {
        return "Sala{" + "espectadores=" + espectadores + ", asientos=" + asientos + '}';
    }
